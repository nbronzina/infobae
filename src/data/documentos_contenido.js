...
export const DOCUMENTOS_CONTENIDO = {
  ...
  narco_cobertura: {
    ...
    secciones: [
      ...
      { titulo: 'Referencia comparativa: México', texto: 'México es la referencia regional para escala de riesgo en cobertura narco. La serie RSF (Round-Up 2024–2025) lo dejó fijado en la línea de base que el sector usa todavía: 28 periodistas asesinados en 2024, 9 en 2025 — la mayoría locales, investigando estructuras criminales con vínculos políticos. La curva se mantuvo en ese rango durante los ejercicios siguientes. Es el mismo patrón que en Rosario, a otra escala. Útil para dimensionar: el riesgo argentino no se proyecta sobre el mexicano, pero comparte vector y asimetría entre corresponsal y periodista local.' }
    ],
    fuentes: 'InSight Crime, Los Monos: reconfiguración post-2025. Plan Bandera PFA dic 2025 (real). De los Santos & Lascano, "Los Monos" (premio FOPEA). FOPEA, protocolo de aviso mutuo. CPJ Argentina country reports. Fiscalía Federal Rosario, expedientes públicos. RSF Round-Up 2025.'
  },
  ...
  seguros_riesgo: {
    ...
    secciones: [
      ...
      { titulo: 'Contexto numérico', texto: 'RSF documenta un promedio sostenido de 50–70 periodistas asesinados por año en actividad desde mediados de la década. La serie 2024–2025 (Round-Up RSF) marcó la línea de base que el sector usa para tarifar riesgo: 124 muertos en 2024, 60 en 2025 — con Palestina y México como teatros recurrentes y mayoría freelance o de medios locales sin cobertura corporativa. La curva se mantuvo dentro de ese rango en los ejercicios posteriores. La póliza complementaria no es burocracia: es la diferencia entre repatriación e impago.' }
    ],
    fuentes: 'Ley 24.557 (ART). ACOS Alliance Freelance Journalist Safety Principles. RSF, programa de seguros para periodistas. RSF Round-Up 2025.'
  },
