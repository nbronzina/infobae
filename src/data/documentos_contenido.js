...
export const DOCUMENTOS_CONTENIDO = {
  ...
  narco_cobertura: {
    ...
    secciones: [
      ...
      { titulo: 'Referencia comparativa: México', texto: 'México es la referencia regional para escala de riesgo en cobertura narco. RSF Round-Up: 9 periodistas asesinados en 2025, 28 el año previo. La mayoría son periodistas locales investigando estructuras criminales con vínculos políticos — el mismo patrón que en Rosario, a otra escala. Útil para dimensionar: el riesgo argentino no se proyecta sobre el mexicano, pero comparte vector y comparte la asimetría entre corresponsal y periodista local.' }
    ],
  ...
  seguros_riesgo: {
    ...
    secciones: [
      ...
      { titulo: 'Contexto numérico', texto: 'RSF documenta entre 50 y 70 periodistas asesinados por año en actividad. Round-Up 2025: 60 muertos, con Palestina (25) y México (9) como teatros sostenidos desde 2024 — la mayoría freelance o de medios locales sin cobertura corporativa. La póliza complementaria no es burocracia, es la diferencia entre repatriación e impago.' }
    ],
